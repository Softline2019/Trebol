...
using SoftLine.Trebol.Infrastructure.Specification;

namespace SoftLine.Trebol.Infrastructure.Repositories;

public class RepositoryBase<T> : IAsyncRepository<T> where T : class
{
    protected readonly TrebolDbContext _context;

    public RepositoryBase(TrebolDbContext context)
    {
        _context = context;
    }

    /// <summary>
    /// Insertar un nuevo record dentro de una entidad
    /// </summary>
